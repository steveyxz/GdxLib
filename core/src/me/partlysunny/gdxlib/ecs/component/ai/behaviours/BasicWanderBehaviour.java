...
public class BasicWanderBehaviour implements BehaviourProvider {
    ...
    public BasicWanderBehaviour(float viewRange, Steerable<Vector2> target, RaycastAvoidanceSettings raycastAvoidanceSettings) {
