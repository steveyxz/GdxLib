...
public class BasicEvadeBehaviour implements BehaviourProvider {
    ...
    public BasicEvadeBehaviour(float viewRange, Steerable<Vector2> target, RaycastAvoidanceSettings raycastAvoidanceSettings) {
